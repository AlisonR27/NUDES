...
<body>
    <header class="header">
        <nav class="navbar navbar-expand-md justify-content-between px-5 py-2">
            <a class="navbar-brand" href="<?php echo $blog_url?>">
                <img src="<?php echo $assets?>/imgs/logo.png" alt="" class="img-fluid" id="navbar-logo" style="max-height:50px;">
                NUDES
            </a>
